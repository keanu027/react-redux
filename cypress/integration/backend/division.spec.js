describe('Division API', function () {
  ...
  const urladdition = '/api/division';
  ...
  it('Test#1 - Register in Division Success', function () {
    const firstnum = 10;
    const secondnum = 10;
  ...
  it('Test#2 - Register in Division Failed', function () {
    const firstnum = '';
    const secondnum = 10;
    ...
    // cy.loginCb('user', '12345678').then((response) => {
    //   cy.log(response);
    //   cy.registerCb(response.body.token, 123, 0).then((response) => {
    //     cy.log(response);
    //     expect(response.status).to.eq(statusCode);
    //   });
    // });
  ...
  it('Test#3 - Get List in Division Success', function () {
    const statusCode = 200;
  ...
  it('Test#4 - Get List in Division Failed', function () {
  ...
  it('Test#5 - Update in Division Success', function () {
    const firstnum = 20;
    const secondnum = 200;
    const statusCode = 200;
  ...
  it('Test#6 - Update in Division Failed', function () {
    const firstnum = '';
    const secondnum = 1;
    const statusCode = 400;
  ...
  it('Test#7 - Delete in Division Success', function () {
    const statusCode = 200;
  ...
  it('Test#8 - Delete in Division Failed', function () {
    const statusCode = 401;
